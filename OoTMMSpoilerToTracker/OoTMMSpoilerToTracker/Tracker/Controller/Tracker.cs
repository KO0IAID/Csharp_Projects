using OoTMMSpoilerToTracker.Tracker.Models;
using OoTMMSpoilerToTracker.Tracker.Models.Items;
using System;
...
namespace OoTMMSpoilerToTracker.Tracker.Controller
{
    public class Tracker
    {
        ...
        private static string? GetTemplatePath()
        {
            ...
            string templateFolder = Path.Combine(baseDir, "Tracker", "Resources", "Tracker Template");
        ...
        {
            string baseDir = AppDomain.CurrentDomain.BaseDirectory;
            string mapDir = Path.Combine(baseDir, "Resources", "Maps");
